...
from sbi_ebm.kernels.base import (Array_T, Config_T, Info, Info_T, Kernel, KernelConfig,
                                           KernelFactory, MHKernel, MHKernelFactory, Result, State, State_T, TunableKernel, TunableMHKernelFactory)
# from sbi_ebm.mala import MALAConfig, MALAKernel, _mala
from sbi_ebm.kernels.mala import MALAConfig, MALAInfo, MALAKernel, MALAKernelFactory, MALAState
from sbi_ebm.kernels.rwmh import RWInfo, RWKernel, RWKernelFactory, RWState
...
class SAVMKernel(TunableKernel[SAVMConfig, SAVMState, SAVMInfo], Generic[Config_T, State_T, Info_T]):
    ...
    def init_state(self: Self, x: Array_T, aux_var0: Optional[Array_T] = None) -> SAVMState[Config_T, State_T, Info_T]:
        ...
        # mcmc chain
        from sbi_ebm.inference_algorithms.mcmc.base import _MCMCChain, _MCMCChainConfig
